<div class="auth-card">
    <div class="auth-card-header">
        ...
        <div>
            <h1 class="auth-card-title mb-1">Create Official Account</h1>
            <p class="auth-meta mb-0">For authorized barangay staff and officials.</p>
        </div>
    </div>
    ...
    <form method="post" action="<?= $baseUrl ?>/register/official" class="auth-form mt-3">
        <div class="mb-3">
        ...
        <p class="text-center small mb-0">
            ...
            <a href="<?= $baseUrl ?>/login/official">Back to official login</a>
        </p>
    </form>
</div>
